import { Component, OnInit, Renderer2, ViewChild, ElementRef, HostListener, Input,
   OnChanges, SimpleChanges, Output, EventEmitter, ChangeDetectorRef } from '@angular/core';
